      ...
      {isLendEther ? (
        <div>
          ...
          <div className="mt-5">
            <a
              ...
              href={"https://cBTC-chain-testnet.blockscout.com" + information.hash}
            ...
            <p className="my-2 break-words">
              Lend Amount: {information.amount} fFIL
            </p>
          </div>
        </div>
      ) : (
        <div>
          {isDone ? (
            <div>
              ...
              <div className="break-words mt-5">
                ...
                <a
                  ...
                  target="_blank"
                  href={"https://cBTC-chain-testnet.blockscout.com/tx/" + lendTokenHash}
                >
                  {lendTokenHash}
                </a>
              </div>
            ...
            <div>
              <div>Lend amount: {information.amount} wETH</div>
              <div className="break-words">
                ...
                <a
                  ...
                  href={
                    "https://cBTC-chain-testnet.blockscout.com/tx/" +
            ...
            <div>
              <div className="break-words my-2">
                ...
                <a
                  ...
                  rel="noopenner noreferrer"
                  href={
                    "https://cBTC-chain-testnet.blockscout.com/address/" +
                    loanContractAddress
                  }
                >
                  {loanContractAddress}
              ...
              <div className="my-2">
                Approve amount: {information.amount} wETH
              </div>
              <div className="my-2">
                {" "}
  ...
  return (
    <div className="mt-10 md:mt-24">
      ...
      <div className="mx-5 md:mx-auto w-[fit-content]">
        <div className="text-[#3272e2] font-bold text-2xl">Lend Order</div>
        <div className="mt-3 mx-auto w-full bg-[#3272e2] h-auto rounded-xl shadow-xl px-5 py-4">
          <div>
            ...
            {!isValidLendAmount && (
              <div className="p-0 flex justify-center items-center text-red-500">
                <AiFillWarning className="mr-2" />
                <div>Minimum lend amount 0.0001 cBTC or 1 wETH token</div>
              </div>
            )}
            {!isEnoughFund && (
              <div className="p-0 flex justify-center items-center text-red-500">
