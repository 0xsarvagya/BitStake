...
const NavItem = ({ active, content, handleOnClick }) => {
  return content == "Contract" ? (
    <a
      ...
      href="https://explorer.testnet.citrea.xyz/address/0xDF11fC9D4Cc9296758fDD422472d5E3430dbAF1E"
      target="_blank"
      ...
      <div className="flex justify-self-end  md:justify-self-end  items-center justify-center">
        ...
        {!account ? (
          ...
          <div className="bg-[#3272e2] flex items-center rounded-2xl p-[1px]">
            <div
              title={userBalance + " " + (isShowingToken ? "wETH" : "cBTC")}
            ...
            >
              ...
              <p className="mr-2">{isShowingToken ? "wETH" : "cBTC"}</p>
            </div>
            <a
              target="_blank"
              rel="noopenner noreferrer"
