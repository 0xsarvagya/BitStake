...
const WithdrawDetails = ({
  ...
  return (
    <div>
      ...
      <div
        className={
          "fixed left-[50%] top-[50%] min-w-[380px] w-[20%] -translate-x-[50%] -translate-y-[50%] bg-[#22437c] mx-auto rounded-xl p-5 shadow-xl transition duration-200 scale-0 z-20 " +
          (isShow ? " scale-100" : "")
        }
      >
          ...
          <div>
            <div>
              ...
              <a
                ...
                href={"https://explorer.glif.io/tx/" + withdrawDetails.hash}
...
const LendList = ({
  ...
  return (
    <div className="mt-4 bg-[#22437c] hover:bg-gray-800 transition px-4 py-3 rounded cursor-pointer text-gray-300">
      ...
      <div>
        {data.isLendEther && (
          <div>
            ...
            <div className="">
              <p className="font-bold text-white underline">Lend cBTC amount</p>{" "}
              <p className="break-words">
                {ethers.utils.formatEther(data.lendAmountEther.toString())} cBTC
              </p>
            </div>
          </div>
        )}
        {!data.isLendEther && (
          <div>
            <div className="">
              ...
              <p className="break-words">
                {data.paybackAmountToken.toString() / 10 ** 18} wETH
              </p>
            </div>
            <div className="">
              <p className="font-bold text-white underline">Lend wETH amount</p>{" "}
              <p className="break-words">
                {data.lendAmountToken.toString() / 10 ** 18} wETH
              </p>
            </div>
          </div>
        )}
      ...
      <div
        ...
        className="mt-3 bg-[#3272e2] px-2 py-2 md:py-3 rounded-2xl text-center text-white cursor-pointer hover:bg-[#1f5ba370] transition text-xl"
      >
        Withdraw
      </div>
    </div>
  ...
  return (
    <div className="mt-4 bg-[#22437c] hover:bg-gray-800 transition px-4 py-3 rounded cursor-pointer text-gray-300">
      ...
      <div>
        <div>
          <div className="">
            <p className="font-bold text-white underline">Loan cBTC amount</p>{" "}
            <p className="break-words">
              {ethers.utils.formatEther(data.loanAmount.toString())} cBTC
            </p>
          </div>
          <div className="">
            <p className="font-bold text-white underline">Payback amount</p>{" "}
            <p className="break-words">
              {ethers.utils.formatEther(data.paybackAmount.toString())} cBTC
            </p>
          </div>
          <div className="">
            <p className="font-bold text-white underline">Collateral amount</p>{" "}
            <p className="break-words">
              {data.collateralAmount.toString() / 10 ** 18} wETH
            </p>
          </div>
        </div>
      </div>
      <div
        ...
        className="mt-3 bg-[#3272e2] px-2 py-2 md:py-3 rounded-2xl text-center text-blue-400 cursor-pointer hover:bg-[#1f5ba370] transition text-xl"
      >
        Payback
      </div>
    </div>
...
export default function Redemption() {
  ...
  return (
    <div className="mx-5 md:mx-auto mt-10 md:mt-24 mb-24 w-auto md:max-w-[550px]">
      <div className="text-[#3272e2] font-bold text-2xl mb-3">Redemption</div>
      <WithdrawDetails
      ...
      />
      <div className="bg-[#3272e2] mx-auto rounded-xl  p-5">
        {loading ? (
          <div>
