...
export default function Confirm({
  ...
  const handleConfirm = async () => {
    console.log(information.loanAmount + "    and   " + information.duration)
    if (account) {
  ...
  return (
    <div className="p-3 mt-5">
      <div className="my-2">Confirm loan for {information.loanAmount} cBTC </div>
      <div className="my-2">
      ...
      {!isConfirming ? (
        !hash ? (
          ...
          <a
            ...
            href={"https://explorer.glif.io/" + hash}
